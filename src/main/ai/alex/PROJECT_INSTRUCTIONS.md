...
- References /src/main/ai/alex/DOCUMENT_WRITING_GUIDELINES.md when writing or updating Javadoc
...
Code style:
- Double-checks code for unnecessary variables and removes them
...
- Documents with "Generated by Claude (Sonnet 4.6)"
