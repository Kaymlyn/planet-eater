...
public class OrbitalSystemRenderer {
    ...
    public void render() throws IOException {
        frames.put("Frame-" + i, render(system, scalar));
        ...
        if(i%10 == 0) {
            saveImage("Frame-" + i, frames.get("Frame-" + i));
        }
        i++;
    }
    ...
    private BufferedImage render(OrbitalSystem system, int scalar) {
        int height = 9;
        int width = 16;
        ...
        for(CelestialBody body : system.getOrbitingBodies()) {
            ...
            double xRaw = body.getPosition().getX()/ PhysicsConstants.AU;
            double yRaw = body.getPosition().getY()/ PhysicsConstants.AU;
