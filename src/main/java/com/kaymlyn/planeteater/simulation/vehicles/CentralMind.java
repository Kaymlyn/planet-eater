 ...
 */
@Getter
public class CentralMind extends Vehicle {
    ...
    public CentralMind(String id, double orbitRadius, OrbitingBody parentBody) {
        super(1e6, 1e4, 1e3, 2, true, 12);
        this.id = id;
        this.orbitRadius = orbitRadius;
        this.inventory = new Composition();
        this.position = new Vector3D(orbitRadius, 0, 0);
        this.velocity = new Vector3D(0, parentBody.circularOrbitVelocity(this.orbitRadius), 0);
    }
     ...
     */
    public double distanceTo(OrbitingBody body) {
